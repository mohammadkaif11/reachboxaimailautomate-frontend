  ...
  return (
    <div>
      ...
      <div className="lg:pl-72">
        {/* Static sidebar button for mobile-responsive */}
        <div className="lg:hidden smsticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4  px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
          <button
            type="button"
